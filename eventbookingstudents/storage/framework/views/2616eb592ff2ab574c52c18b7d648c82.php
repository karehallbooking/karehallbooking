...
<div class="section-block" style="margin-bottom: 24px;">
    ...
    <div style="margin-bottom: 16px;">
        <?php if($event->is_paid && $event->amount > 0): ?>
            <span class="tag tag-paid">Paid Event - ₹<?php echo e(number_format($event->amount, 2)); ?></span>
...
<?php if($hasPaidPayment && $ticketCode): ?>
    <div class="section-block" style="background: #e8f5e9; border-color: #4caf50;">
        ...
        <p style="margin: 0; color: #555;">
            <strong>Ticket Code:</strong> <?php echo e($ticketCode); ?><br>
            <strong>Registration Date:</strong> <?php echo e($registration->registered_at->format('d M Y, h:i A') ?? 'N/A'); ?>

        </p>
        <div style="margin-top: 12px;">
            <a href="<?php echo e(route('payment.success', ['ticket' => $ticketCode])); ?>" class="btn btn-primary">View Ticket</a>
        </div>
    </div>
        ...
        <form id="registration-form">
            ...
            <div class="form-container-row">
                <div class="form-group-box">
                    ...
                    <input type="text" name="student_name" id="student_name" value="<?php echo e($registration->student_name); ?>" required class="form-input-box" readonly>
                </div>
                
                <div class="form-group-box">
                    <label class="form-label-bold">Email *</label>
                    <input type="email" name="student_email" id="student_email" value="<?php echo e($registration->student_email); ?>" required class="form-input-box" readonly>
                </div>
                
                <div class="form-group-box">
                    <label class="form-label-bold">Roll Number / Student ID *</label>
                    <input type="text" name="student_roll" id="student_roll" value="<?php echo e($registration->student_id); ?>" required class="form-input-box" readonly>
                </div>
                
                <div class="form-group-box">
                    <label class="form-label-bold">Phone (Optional)</label>
                    <input type="text" name="student_phone" id="student_phone" value="<?php echo e($registration->student_phone); ?>" class="form-input-box" readonly>
                </div>
            </div>
            
            <div style="margin-top: 20px; text-align: center;">
                <button type="button" id="pay-btn" class="btn btn-primary" style="padding: 12px 32px; font-size: 15px; font-weight: 600;">Pay ₹<?php echo e(number_format($event->amount, 2)); ?> and Register</button>
            </div>
        </form>
    </div>
        ...
        <form id="registration-form">
            ...
            <div class="form-container-row">
                <div class="form-group-box">
                    <label class="form-label-bold">Full Name *</label>
                    <small class="form-hint">(This name will appear on your certificate)</small>
                    <input type="text" name="student_name" id="student_name" value="<?php echo e($studentName ?? old('student_name')); ?>" required class="form-input-box">
                </div>
                
                <div class="form-group-box">
                    <label class="form-label-bold">Email *</label>
                    <input type="email" name="student_email" id="student_email" value="<?php echo e($studentEmail ?? old('student_email')); ?>" required class="form-input-box">
                </div>
                
                <div class="form-group-box">
                    <label class="form-label-bold">Roll Number / Student ID *</label>
                    <input type="text" name="student_roll" id="student_roll" value="<?php echo e($studentRoll ?? old('student_roll')); ?>" required class="form-input-box">
                </div>
                
                <div class="form-group-box">
                    <label class="form-label-bold">Phone (Optional)</label>
                    <input type="text" name="student_phone" id="student_phone" value="<?php echo e($studentPhone ?? old('student_phone')); ?>" class="form-input-box">
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (payBtn) {
        payBtn.addEventListener('click', function() {
            ...
            fetch('<?php echo e(route("events.createOrder", $event->id)); ?>', {
                method: 'POST',
                headers: {
            ...
            .then(function(data) {
                ...
                var options = {
                    ...
                    handler: function (rzpResponse) {
                        ...
                        fetch('<?php echo e(route("payment.success.post")); ?>', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': csrfToken,
                        ...
                        .then(function(responseData) {
                            ...
                            if (responseData.success && responseData.redirect_url) {
                                ...
                                window.location.href = '<?php echo e(route("payment.failure")); ?>';
                            }
                        })
                        .catch(function(err) {
                            hideLoading();
    ...
    if (registerBtn) {
        registerBtn.addEventListener('click', function() {
            ...
            if (form) {
                form.action = '<?php echo e(route("student.events.register", $event->id)); ?>';
                form.method = 'POST';
                form.submit();
            }
        });
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sande\Downloads\KAREHALL\eventbookingstudents\resources\views/events/register.blade.php ENDPATH**/ ?>