...
import { Calendar, Filter, Search, Clock, CheckCircle, XCircle } from 'lucide-react';
  ...
  return (
    <AdminLayout>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <p className="text-gray-600">View and manage all hall booking requests</p>
      </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredBookings.map((booking) => (
                  <tr key={booking.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{booking.dates.join(', ')}</div>
                      <div className="text-sm text-gray-500">{booking.timeFrom} - {booking.timeTo}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-900 max-w-xs truncate">{booking.purpose}</div>
                      <div className="text-sm text-gray-500">Capacity: {booking.seatingCapacity}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
