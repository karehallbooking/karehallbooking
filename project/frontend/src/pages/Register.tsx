...
import { User, Mail, Phone, Lock, GraduationCap, School, Eye, EyeOff } from 'lucide-react';
...
export function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary to-primary-dark">
      ...
      {/* Main Content */}
      <div className="flex items-center justify-center min-h-screen px-4 py-12 pt-24">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8">
        <div className="text-center mb-8">
          <School className="h-12 w-12 text-primary mx-auto mb-4" />
          <h2 className="text-3xl font-bold text-gray-800 mb-2">Create Account</h2>
          <p className="text-gray-600">Join the KARE Hall Booking System</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Enter department/institution"
            />
          </div>
